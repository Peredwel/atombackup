...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'warning',
  'file' => '/usr/share/nginx/atom-2.6.4/log/qubit_cli.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/usr/share/nginx/atom-2.6.4/cache/qubit/cli/template',
  'lifetime' => 86400,
  'prefix' => '/usr/share/nginx/atom-2.6.4/apps/qubit/template',
));
